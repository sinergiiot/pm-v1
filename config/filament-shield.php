...
return [
    ...
    */
    ...
    'custom_permissions' => [
        ...
        // Project view tabs (per-tab access)
        'view_ProjectResource_ViewProject' => 'Project Overview',
        'view_ProjectResource_ProjectTaskList' => 'Project Task List',
        'view_ProjectResource_ProjectKanban' => 'Project Board',
        'view_ProjectResource_ProjectCalendar' => 'Project Calendar',
        'view_ProjectResource_ProjectGantt' => 'Project Gantt',
        'view_ProjectResource_ProjectZoom' => 'Project Zoom',
        'view_ProjectResource_ProjectFileManagement' => 'Project File Management',
        'view_ProjectResource_ProjectTransactions' => 'Project Transactions',
        'view_ProjectResource_ProjectProfitLoss' => 'Project Profit & Loss',
        'view_ProjectResource_ProjectCashFlow' => 'Project Cash Flow',
    ],
