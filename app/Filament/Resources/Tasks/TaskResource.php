...
class TaskResource extends Resource
{
    ...
    public static function getPages(): array
    {
        return [
            ...
            // Route view tetap didaftarkan agar URL generator (global search, dll) tidak error.
            // Di table, ViewAction memakai modal (url null + modalContent).
            'view' => ViewTask::route('/{record}'),
            // 'viewV1' => ViewTask::route('/{record}'),
